...
describe("row mapping", () => {
  const row: UsageEventRow = {
    ...
    provider_identity_hash: null, economic_event_key: null, dedupe_status: "unkeyed", economic_verification_status: null, economic_verification_policy_version: null, protocol_compute_pico: null, eligible_compute_pico: null, pricing_components_pending: [],
