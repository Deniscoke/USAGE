...
describe("a future snapshot admits only the bottom of the ladder", () => {
  const settled: UsageEventRow = {
    ...
    identity_trust_level: "account", provider_identity_hash: null, economic_event_key: null, dedupe_status: "unkeyed", economic_verification_status: null, economic_verification_policy_version: null, protocol_compute_pico: null, eligible_compute_pico: null, pricing_components_pending: [], created_at: "2026-09-10T10:00:01Z",
  };
